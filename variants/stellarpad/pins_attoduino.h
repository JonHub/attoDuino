...
// use attoduin mapping called "D1" ... these just map the atto pin, to the
// appropriate energia pin
// can change this later to make more sense

// the first 10 digital pins works as the analog pins
...
// atto ... this is the one that needs to change ...
